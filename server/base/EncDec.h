...
public:
    ...
    string Decrypt2(const std::string& str_in, const std::string& key, const std::string& iv);
    string Encrypt2(const std::string& str_in, const std::string& key, const std::string& iv);
