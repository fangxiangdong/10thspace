...
enum{
	RELATION_ACTION_ADD_FRIEND,    //加好友
    RELATION_ACTION_ADD_FOLLOW    //加关注
};

enum {
	RELATION_TYPE_FRIEND,    //好友
	RELATION_TYPE_FOLLOW_BIG,    //小的关注大的
    RELATION_TYPE_FOLLOW_SMALL,    //大的关注小的
	RELATION_TYPE_FOLLOW_EACH_OTHER    //相互关注
};
