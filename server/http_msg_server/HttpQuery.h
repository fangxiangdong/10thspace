...
private:
    ...
    static void _QueryRegister(const string& strAppKey, Json::Value &post_json_obj, CHttpConn *pHttpConn);
    ...
    void _QueryValidCode(const string& strAppKey, Json::Value &post_json_obj, CHttpConn *pHttpConn);
    void _AssertValidCode(const string& strAppKey, Json::Value &post_json_obj, CHttpConn *pHttpConn);
private:
