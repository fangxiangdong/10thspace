...
private:
    ...
    void _HandleClientAddFriendReadDataAck(CImPdu* pPdu);
    void _HandleClientGetAddFriendDataRequest(CImPdu* pPdu);
    void _HandleClientAddFriendUnreadCntRequest(CImPdu* pPdu);
