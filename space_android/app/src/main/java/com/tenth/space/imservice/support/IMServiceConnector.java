package com.tenth.space.imservice.support;
...
import com.tenth.space.imservice.service.IMService.IMServiceBinder;
...
public abstract class IMServiceConnector {
    ...
    public void disconnect(Context ctx) {
		logger.i("im#disconnect");
		unbindService(ctx);
        IMServiceConnector.this.onServiceDisconnected();
	}

	public boolean bindService(Context ctx) {
		logger.i("im#bindService");
