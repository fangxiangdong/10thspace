...
import com.tenth.space.utils.BitmapCache;
import com.tenth.space.utils.BitmapCache.ImageCallback;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if ((Bimp.bmpPaths.size() + selectTotal) < 9) {
				...
				} else if ((Bimp.bmpPaths.size() + selectTotal) >= 9) {
