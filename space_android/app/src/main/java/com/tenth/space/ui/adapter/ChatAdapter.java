...
public class ChatAdapter extends BaseAdapter {
	...
	public int getCount() {
		...
		public RecentInfo getItem(int position) {
			logger.i("recent#getItem position:%d", position);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		//		logger.i("recent#getview position:%d", position);
		try {
	...
	public void setData(List<RecentInfo> recentSessionList) {
		logger.i("recent#set New recent session list");
		logger.i("recent#notifyDataSetChanged");
