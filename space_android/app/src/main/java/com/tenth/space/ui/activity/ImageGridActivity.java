...
import com.tenth.space.ui.adapter.album.ImageGridAdapter;
import com.tenth.space.ui.adapter.album.ImageGridAdapter.TextCallback;
...
public class ImageGridActivity extends Activity implements OnTouchListener {
    ...
    private void initView() {
        ...
        finish.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
            	logger.i("pic#click send image btn");
                if (adapter.getSelectMap().size() > 0) {
                    ...
                    setSendText(0);
                    EventBus.getDefault().postSticky(new SelectEvent(itemList));
