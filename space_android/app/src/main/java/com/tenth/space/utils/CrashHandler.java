...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
     ...
     * @throws
     */
    public void init(Context context, IMApplication app) {
        // 传入app对象，为完美终止app
        this.app = app;
        mContext = context;
    ...
    private boolean handleException(Throwable ex) {
        ...
        //Log.i("GTAG","temp="+temp);
        //temp是文件夹，保存文件夹路径到偏好存储里面
           // SPUtil.put(mContext,"path",temp);
        return true;
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(
                 ...
                 path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/crashs/";
