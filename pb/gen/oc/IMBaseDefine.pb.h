...
typedef NS_ENUM(SInt32, ServiceID) {
  ...
  ServiceIDSidRegister = 9,
  ServiceIDSidBlog = 10,
  ServiceIDSidSystem = 11,
};

BOOL ServiceIDIsValidValue(ServiceID value);
NSString *NSStringFromServiceID(ServiceID value);

typedef NS_ENUM(SInt32, BlogCmdID) {
  BlogCmdIDCidBlogSend = 2561,
  BlogCmdIDCidBlogSendAck = 2562,
  BlogCmdIDCidBlogGetListRequest = 2563,
  BlogCmdIDCidBlogGetListResponse = 2564,
  BlogCmdIDCidBlogAddCommentRequest = 2565,
  BlogCmdIDCidBlogAddCommentResponse = 2566,
  BlogCmdIDCidBlogGetCommentRequest = 2567,
  BlogCmdIDCidBlogGetCommentResponse = 2568,
};

BOOL BlogCmdIDIsValidValue(BlogCmdID value);
NSString *NSStringFromBlogCmdID(BlogCmdID value);

typedef NS_ENUM(SInt32, RegisterCmdID) {
  RegisterCmdIDCidRegisterReq = 2305,
  RegisterCmdIDCidRegisterRsp = 2306,
};
...
typedef NS_ENUM(SInt32, BuddyListCmdID) {
  ...
  BuddyListCmdIDCidBuddyListSearchUserRequest = 534,
  BuddyListCmdIDCidBuddyListSearchUserResponse = 535,
  BuddyListCmdIDCidBuddyListAddFriendRequest = 536,
  BuddyListCmdIDCidBuddyListAddFriendResponse = 537,
  BuddyListCmdIDCidBuddyListAddFriendData = 538,
  BuddyListCmdIDCidBuddyListAddFriendReadDataAck = 539,
  BuddyListCmdIDCidBuddyListAddFriendUnreadCntRequest = 540,
  BuddyListCmdIDCidBuddyListAddFriendUnreadCntResponse = 541,
  BuddyListCmdIDCidBuddyListAgreeAddFriendRequest = 542,
  BuddyListCmdIDCidBuddyListAgreeAddFriendResponse = 543,
  BuddyListCmdIDCidBuddyListFollowUserRequest = 544,
  BuddyListCmdIDCidBuddyListFollowUserResponse = 545,
  BuddyListCmdIDCidBuddyListDelFriendRequest = 546,
  BuddyListCmdIDCidBuddyListDelFriendResponse = 547,
  BuddyListCmdIDCidBuddyListDelFollowUserRequest = 548,
  BuddyListCmdIDCidBuddyListDelFollowUserResponse = 549,
  BuddyListCmdIDCidBuddyListGetAddFriendDataRequest = 550,
  BuddyListCmdIDCidBuddyListGetAddFriendDataResponse = 551,
  BuddyListCmdIDCidBuddyListAllOnlineUserCntRequest = 552,
...
typedef NS_ENUM(SInt32, OtherCmdID) {
  ...
  OtherCmdIDCidOtherRegisterReq = 1845,
  OtherCmdIDCidOtherRegisterRsp = 1846,
};
...
typedef NS_ENUM(SInt32, SessionType) {
  ...
  SessionTypeSessionTypeSystem = 3,
  SessionTypeSessionTypeErrorNotFriend = 32,
};
...
typedef NS_ENUM(SInt32, MsgType) {
  ...
  MsgTypeMsgTypeErrorNotFriend = 32,
};

BOOL MsgTypeIsValidValue(MsgType value);
NSString *NSStringFromMsgType(MsgType value);

typedef NS_ENUM(SInt32, BlogType) {
  BlogTypeBlogTypeRcommend = 1,
  BlogTypeBlogTypeFriend = 2,
  BlogTypeBlogTypeFollowuser = 3,
};

BOOL BlogTypeIsValidValue(BlogType value);
NSString *NSStringFromBlogType(BlogType value);

typedef NS_ENUM(SInt32, BlogType2) {
  BlogType2BlogType2Blog = 1,
  BlogType2BlogType2Comment = 2,
};

BOOL BlogType2IsValidValue(BlogType2 value);
NSString *NSStringFromBlogType2(BlogType2 value);

typedef NS_ENUM(SInt32, SystemMsgType) {
  SystemMsgTypeAddFriendRequest = 1,
  SystemMsgTypeAddFriendAgree = 2,
  SystemMsgTypeAddFriendDisagree = 3,
};
...
typedef NS_ENUM(SInt32, UserRelationType) {
  UserRelationTypeRelationRecommend = 0,
  UserRelationTypeRelationFriend = 1,
  UserRelationTypeRelationFollow = 2,
};
...
#define UserInfo_updated @"updated"
#define UserInfo_relation @"relation"
#define UserInfo_fans_cnt @"fansCnt"
...
@property (readonly) UInt32 updated;
@property (readonly) UserRelationType relation;
@property (readonly) UInt32 fansCnt;
...
#define BlogInfo_blog_id @"blogId"
#define BlogInfo_writer_user_id @"writerUserId"
#define BlogInfo_nick_name @"nickName"
#define BlogInfo_avatar_url @"avatarUrl"
#define BlogInfo_like_cnt @"likeCnt"
#define BlogInfo_comment_cnt @"commentCnt"
#define BlogInfo_create_time @"createTime"
#define BlogInfo_blog_data @"blogData"
@interface BlogInfo : PBGeneratedMessage<GeneratedMessageProtocol> {
@private
  BOOL hasNickName_:1;
  BOOL hasAvatarUrl_:1;
  BOOL hasBlogData_:1;
  BOOL hasBlogId_:1;
  BOOL hasWriterUserId_:1;
  BOOL hasLikeCnt_:1;
...
@property (readonly) UInt32 writerUserId;
@property (readonly, strong) NSString* nickName;
@property (readonly, strong) NSString* avatarUrl;
@property (readonly) UInt32 likeCnt;
@property (readonly) UInt32 commentCnt;
@property (readonly) UInt32 createTime;
...
@interface BlogInfoBuilder : PBGeneratedMessageBuilder {
@private
  BlogInfo* resultBlogInfo;
}
