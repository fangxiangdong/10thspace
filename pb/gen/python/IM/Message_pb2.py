...
_IMGETONLINEUSERCNTREQ = _descriptor.Descriptor(
  name='IMGetOnlineUserCntReq',
  full_name='IM.Message.IMGetOnlineUserCntReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_IMGETONLINEUSERCNTRSP = _descriptor.Descriptor(
  name='IMGetOnlineUserCntRsp',
  full_name='IM.Message.IMGetOnlineUserCntRsp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='online_user_cnt', full_name='IM.Message.IMGetOnlineUserCntRsp.online_user_cnt', index=0,
      number=1, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['IMGetOnlineUserCntReq'] = _IMGETONLINEUSERCNTREQ
DESCRIPTOR.message_types_by_name['IMGetOnlineUserCntRsp'] = _IMGETONLINEUSERCNTRSP
...
IMGetOnlineUserCntReq = _reflection.GeneratedProtocolMessageType('IMGetOnlineUserCntReq', (_message.Message,), dict(
  DESCRIPTOR = _IMGETONLINEUSERCNTREQ,
  __module__ = 'IM.Message_pb2'
  # @@protoc_insertion_point(class_scope:IM.Message.IMGetOnlineUserCntReq)
  ))
_sym_db.RegisterMessage(IMGetOnlineUserCntReq)

IMGetOnlineUserCntRsp = _reflection.GeneratedProtocolMessageType('IMGetOnlineUserCntRsp', (_message.Message,), dict(
  DESCRIPTOR = _IMGETONLINEUSERCNTRSP,
  __module__ = 'IM.Message_pb2'
  # @@protoc_insertion_point(class_scope:IM.Message.IMGetOnlineUserCntRsp)
  ))
_sym_db.RegisterMessage(IMGetOnlineUserCntRsp)
