 ...
 *  @param password 密码
 */
- (void)loginWithUsername:(NSString*)name password:(NSDictionary*)password andDict:(NSDictionary*)dic success:(void(^)(MTTUserEntity* user))success  failure:(void(^)(NSString* error))failure;
/**
 *  离线
 */
