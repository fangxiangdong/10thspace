...
- (NSString *)getHomeImgKeyName
{
    MTTUserEntity *userEntuty = (MTTUserEntity *)TheRuntime.user;
    return [NSString stringWithFormat:@"%@", userEntuty.userID];
}
...
-(NSString *)getKeyName
{
    ...
    return [NSString stringWithFormat:@"%@",timeLocal];
}
