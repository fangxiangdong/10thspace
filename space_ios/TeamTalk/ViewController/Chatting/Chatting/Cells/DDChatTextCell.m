...
- (void)setContent:(MTTMessageEntity*)content
{
    ...
    NSString *labelContent = [[SecurityUtil  decryptAESData:content.msgContent]stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    //NSLog(@"---- labelContent == %@",labelContent);
...
{
    NSString* content = [[SecurityUtil  decryptAESData:message.msgContent] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
