...
@interface ConcernFirstItemView()<AVCaptureVideoDataOutputSampleBufferDelegate>
...
@implementation ConcernFirstItemView
...
- (void)listenForEvents
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(otherViewCameraOpen:) name:@"FriendViewCameraOpen" object:nil];
    /** 当前窗口显示的是自己的view*/
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(currentViewIsConcernView:) name:@"ConcernView" object:nil];
    /** 当前窗口显示的不是自己的view*/
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(otherViewWillShow:) name:@"RecommendView" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(otherViewWillShow:) name:@"FriendView" object:nil];
    /** 控制器view消失*/
...
- (void)currentViewIsConcernView:(NSNotification *)note
{
    NSString *cameraStatus = [[NSUserDefaults standardUserDefaults] objectForKey:@"currentCameraStatus"];
    // 相机打开状态
    if ([cameraStatus isEqualToString:@"cameraOpen"]) {
...
- (void)dealWithCameraData
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ConcernViewCameraOpen" object:self userInfo:nil];
