...
@interface MTTWaterDropRefresh () <CAAnimationDelegate> {
    BOOL _isRefresh;
}
...
@implementation MTTWaterDropRefresh
...
- (void)resetWater {
    ...
    if(_currentOffset == 0) {
        ...
        [[MTTSoundManager sharedInstance] playRefreshSound];
