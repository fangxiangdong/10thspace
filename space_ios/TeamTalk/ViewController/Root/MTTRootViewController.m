...
- (void)viewDidLoad
{
    ...
    UIImage* conversationSelected = [[UIImage imageNamed:@"news2"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    recentVC.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"消息" image:[UIImage imageNamed:@"news"] selectedImage:conversationSelected];
    ...
    UIImage* contactSelected = [[UIImage imageNamed:@"new_contacts2"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ContactsViewController *contactVC =[ContactsViewController new];
    contactVC.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"通讯录" image:[UIImage imageNamed:@"new_contacts"]selectedImage:contactSelected];
    ...
    UIImage* xunxinSelected = [[UIImage imageNamed:@"home2"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    XunXinViewController *XunXinVC =[[XunXinViewController alloc] init];
    XunXinVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"首页" image:[UIImage imageNamed:@"home"] selectedImage:xunxinSelected];
    XunXinVC.tabBarItem.tag = 102;
    [XunXinVC.tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObject:RGB(26, 140, 242) forKey:NSForegroundColorAttributeName] forState:UIControlStateSelected];
    XunXinVC.hidesBottomBarWhenPushed =YES;
    
    
    UIImage* myProfileSelected = [[UIImage imageNamed:@"me2"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    MTTMyViewController *myVC =[MTTMyViewController new];
    myVC.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"我的" image:[UIImage imageNamed:@"me"] selectedImage:myProfileSelected];
    ...
    UIImage* findSelected = [[UIImage imageNamed:@"finder2"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    MTTFinderViewController *findVC = [[MTTFinderViewController alloc] init]; // tab_find
    findVC.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"发现" image:[UIImage imageNamed:@"finder"] selectedImage:findSelected];
    findVC.tabBarItem.tag=104;
    ...
    self.viewControllers=@[XunXinVC, recentVC, contactVC, findVC, myVC];
    self.delegate=self;
    //self.title=APP_NAME;
}
