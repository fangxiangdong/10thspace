...
- (id)initWithSessionIDBySystem:(MXXSystemEntity*)system
{
    SessionType sessionType = SessionTypeSessionTypeSystem;
    MTTSessionEntity *session = [self initWithSessionID:system.objID type:sessionType];
