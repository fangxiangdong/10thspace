...
- (BOOL) hasUserName {
  return resultImregisterRsp.hasUserName;
}
- (NSString*) userName {
  return resultImregisterRsp.userName;
}
- (IMRegisterRspBuilder*) setUserName:(NSString*) value {
  resultImregisterRsp.hasUserName = YES;
  resultImregisterRsp.userName = value;
  return self;
}
- (IMRegisterRspBuilder*) clearUserName {
  resultImregisterRsp.hasUserName = NO;
  resultImregisterRsp.userName = @"";
  return self;
}
- (BOOL) hasResultCode {
...
- (IMRegisterRspBuilder*) setResultCode:(UInt32) value {
...
- (IMRegisterRspBuilder*) clearResultCode {
  ...
  resultImregisterRsp.resultCode = 0;
  return self;
}
- (BOOL) hasResultString {
...
- (BOOL) hasUserInfo {
  return resultImregisterRsp.hasUserInfo;
}
- (UserInfo*) userInfo {
  return resultImregisterRsp.userInfo;
}
- (IMRegisterRspBuilder*) setUserInfo:(UserInfo*) value {
  resultImregisterRsp.hasUserInfo = YES;
  resultImregisterRsp.userInfo = value;
  return self;
}
- (IMRegisterRspBuilder*) setUserInfoBuilder:(UserInfoBuilder*) builderForValue {
  return [self setUserInfo:[builderForValue build]];
}
- (IMRegisterRspBuilder*) mergeUserInfo:(UserInfo*) value {
  if (resultImregisterRsp.hasUserInfo &&
      resultImregisterRsp.userInfo != [UserInfo defaultInstance]) {
    resultImregisterRsp.userInfo =
      [[[UserInfo builderWithPrototype:resultImregisterRsp.userInfo] mergeFrom:value] buildPartial];
  } else {
    resultImregisterRsp.userInfo = value;
  }
  resultImregisterRsp.hasUserInfo = YES;
...
- (IMRegisterRspBuilder*) clearUserInfo {
  resultImregisterRsp.hasUserInfo = NO;
  resultImregisterRsp.userInfo = [UserInfo defaultInstance];
  return self;
}
- (BOOL) hasAttachData {
