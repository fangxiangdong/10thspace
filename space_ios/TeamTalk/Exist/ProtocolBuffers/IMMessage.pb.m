...
@interface IMGetOnlineUserCntReq ()
@end

@implementation IMGetOnlineUserCntReq
...
static IMGetOnlineUserCntReq* defaultIMGetOnlineUserCntReqInstance = nil;
+ (void) initialize {
  if (self == [IMGetOnlineUserCntReq class]) {
    defaultIMGetOnlineUserCntReqInstance = [[IMGetOnlineUserCntReq alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultIMGetOnlineUserCntReqInstance;
}
- (instancetype) defaultInstance {
  return defaultIMGetOnlineUserCntReqInstance;
}
...
+ (IMGetOnlineUserCntReq*) parseFromData:(NSData*) data {
  return (IMGetOnlineUserCntReq*)[[[IMGetOnlineUserCntReq builder] mergeFromData:data] build];
}
+ (IMGetOnlineUserCntReq*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMGetOnlineUserCntReq*)[[[IMGetOnlineUserCntReq builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (IMGetOnlineUserCntReq*) parseFromInputStream:(NSInputStream*) input {
  return (IMGetOnlineUserCntReq*)[[[IMGetOnlineUserCntReq builder] mergeFromInputStream:input] build];
}
+ (IMGetOnlineUserCntReq*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMGetOnlineUserCntReq*)[[[IMGetOnlineUserCntReq builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMGetOnlineUserCntReq*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (IMGetOnlineUserCntReq*)[[[IMGetOnlineUserCntReq builder] mergeFromCodedInputStream:input] build];
}
+ (IMGetOnlineUserCntReq*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMGetOnlineUserCntReq*)[[[IMGetOnlineUserCntReq builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMGetOnlineUserCntReqBuilder*) builder {
  return [[IMGetOnlineUserCntReqBuilder alloc] init];
}
+ (IMGetOnlineUserCntReqBuilder*) builderWithPrototype:(IMGetOnlineUserCntReq*) prototype {
  return [[IMGetOnlineUserCntReq builder] mergeFrom:prototype];
}
- (IMGetOnlineUserCntReqBuilder*) builder {
  return [IMGetOnlineUserCntReq builder];
}
- (IMGetOnlineUserCntReqBuilder*) toBuilder {
  return [IMGetOnlineUserCntReq builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  [self.unknownFields writeDescriptionTo:output withIndent:indent];
}
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[IMGetOnlineUserCntReq class]]) {
    return NO;
  }
  IMGetOnlineUserCntReq *otherMessage = other;
  return
      (self.unknownFields == otherMessage.unknownFields || (self.unknownFields != nil && [self.unknownFields isEqual:otherMessage.unknownFields]));
}
- (NSUInteger) hash {
...
@interface IMGetOnlineUserCntReqBuilder()
@property (strong) IMGetOnlineUserCntReq* resultImgetOnlineUserCntReq;
@end

@implementation IMGetOnlineUserCntReqBuilder
@synthesize resultImgetOnlineUserCntReq;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultImgetOnlineUserCntReq = [[IMGetOnlineUserCntReq alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultImgetOnlineUserCntReq;
}
- (IMGetOnlineUserCntReqBuilder*) clear {
  self.resultImgetOnlineUserCntReq = [[IMGetOnlineUserCntReq alloc] init];
  return self;
}
- (IMGetOnlineUserCntReqBuilder*) clone {
  return [IMGetOnlineUserCntReq builderWithPrototype:resultImgetOnlineUserCntReq];
}
- (IMGetOnlineUserCntReq*) defaultInstance {
  return [IMGetOnlineUserCntReq defaultInstance];
}
- (IMGetOnlineUserCntReq*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (IMGetOnlineUserCntReq*) buildPartial {
  IMGetOnlineUserCntReq* returnMe = resultImgetOnlineUserCntReq;
  self.resultImgetOnlineUserCntReq = nil;
  return returnMe;
}
- (IMGetOnlineUserCntReqBuilder*) mergeFrom:(IMGetOnlineUserCntReq*) other {
  if (other == [IMGetOnlineUserCntReq defaultInstance]) {
    return self;
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
- (IMGetOnlineUserCntReqBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (IMGetOnlineUserCntReqBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
...
@interface IMGetOnlineUserCntRsp ()
@property UInt32 onlineUserCnt;
@end

@implementation IMGetOnlineUserCntRsp
...
static IMGetOnlineUserCntRsp* defaultIMGetOnlineUserCntRspInstance = nil;
+ (void) initialize {
  if (self == [IMGetOnlineUserCntRsp class]) {
    defaultIMGetOnlineUserCntRspInstance = [[IMGetOnlineUserCntRsp alloc] init];
  }
}
+ (instancetype) defaultInstance {
  return defaultIMGetOnlineUserCntRspInstance;
}
- (instancetype) defaultInstance {
  return defaultIMGetOnlineUserCntRspInstance;
}
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  if (self.hasOnlineUserCnt) {
    [output writeUInt32:1 value:self.onlineUserCnt];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (SInt32) serializedSize {
  ...
  size_ = 0;
  if (self.hasOnlineUserCnt) {
    size_ += computeUInt32Size(1, self.onlineUserCnt);
  }
  size_ += self.unknownFields.serializedSize;
  memoizedSerializedSize = size_;
  return size_;
}
+ (IMGetOnlineUserCntRsp*) parseFromData:(NSData*) data {
  return (IMGetOnlineUserCntRsp*)[[[IMGetOnlineUserCntRsp builder] mergeFromData:data] build];
}
+ (IMGetOnlineUserCntRsp*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMGetOnlineUserCntRsp*)[[[IMGetOnlineUserCntRsp builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (IMGetOnlineUserCntRsp*) parseFromInputStream:(NSInputStream*) input {
  return (IMGetOnlineUserCntRsp*)[[[IMGetOnlineUserCntRsp builder] mergeFromInputStream:input] build];
}
+ (IMGetOnlineUserCntRsp*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMGetOnlineUserCntRsp*)[[[IMGetOnlineUserCntRsp builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMGetOnlineUserCntRsp*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (IMGetOnlineUserCntRsp*)[[[IMGetOnlineUserCntRsp builder] mergeFromCodedInputStream:input] build];
}
+ (IMGetOnlineUserCntRsp*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (IMGetOnlineUserCntRsp*)[[[IMGetOnlineUserCntRsp builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (IMGetOnlineUserCntRspBuilder*) builder {
  return [[IMGetOnlineUserCntRspBuilder alloc] init];
}
+ (IMGetOnlineUserCntRspBuilder*) builderWithPrototype:(IMGetOnlineUserCntRsp*) prototype {
  return [[IMGetOnlineUserCntRsp builder] mergeFrom:prototype];
}
- (IMGetOnlineUserCntRspBuilder*) builder {
  return [IMGetOnlineUserCntRsp builder];
}
- (IMGetOnlineUserCntRspBuilder*) toBuilder {
  return [IMGetOnlineUserCntRsp builderWithPrototype:self];
}
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  if (self.hasOnlineUserCnt) {
...
- (BOOL) isEqual:(id)other {
  ...
  if (![other isKindOfClass:[IMGetOnlineUserCntRsp class]]) {
    return NO;
  }
  IMGetOnlineUserCntRsp *otherMessage = other;
  return
...
@interface IMGetOnlineUserCntRspBuilder()
@property (strong) IMGetOnlineUserCntRsp* resultImgetOnlineUserCntRsp;
@end

@implementation IMGetOnlineUserCntRspBuilder
@synthesize resultImgetOnlineUserCntRsp;
- (instancetype) init {
  if ((self = [super init])) {
    self.resultImgetOnlineUserCntRsp = [[IMGetOnlineUserCntRsp alloc] init];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
  return resultImgetOnlineUserCntRsp;
}
- (IMGetOnlineUserCntRspBuilder*) clear {
  self.resultImgetOnlineUserCntRsp = [[IMGetOnlineUserCntRsp alloc] init];
  return self;
}
- (IMGetOnlineUserCntRspBuilder*) clone {
  return [IMGetOnlineUserCntRsp builderWithPrototype:resultImgetOnlineUserCntRsp];
}
- (IMGetOnlineUserCntRsp*) defaultInstance {
  return [IMGetOnlineUserCntRsp defaultInstance];
}
- (IMGetOnlineUserCntRsp*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (IMGetOnlineUserCntRsp*) buildPartial {
  IMGetOnlineUserCntRsp* returnMe = resultImgetOnlineUserCntRsp;
  self.resultImgetOnlineUserCntRsp = nil;
  return returnMe;
}
- (IMGetOnlineUserCntRspBuilder*) mergeFrom:(IMGetOnlineUserCntRsp*) other {
  if (other == [IMGetOnlineUserCntRsp defaultInstance]) {
    return self;
  }
...
- (IMGetOnlineUserCntRspBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (IMGetOnlineUserCntRspBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSetBuilder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    SInt32 tag = [input readTag];
    switch (tag) {
...
- (BOOL) hasOnlineUserCnt {
  return resultImgetOnlineUserCntRsp.hasOnlineUserCnt;
}
- (UInt32) onlineUserCnt {
  return resultImgetOnlineUserCntRsp.onlineUserCnt;
}
- (IMGetOnlineUserCntRspBuilder*) setOnlineUserCnt:(UInt32) value {
  resultImgetOnlineUserCntRsp.hasOnlineUserCnt = YES;
  resultImgetOnlineUserCntRsp.onlineUserCnt = value;
  return self;
}
- (IMGetOnlineUserCntRspBuilder*) clearOnlineUserCnt {
  resultImgetOnlineUserCntRsp.hasOnlineUserCnt = NO;
  resultImgetOnlineUserCntRsp.onlineUserCnt = 0;
  return self;
}
@end
